        ...
        <div className="grid lg:grid-cols-2 gap-1 items-center">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-tight mb-6 tracking-tight text-white italic">
              Find Your Perfect
              <br />
              <span className="bg-linear-to-r from-cyan-300 via-blue-300 to-indigo-300 bg-clip-text text-transparent italic">Part-Time Job Today</span>
            </h1>

            {/* Subheading */}
            <p className="text-lg text-white/80 mb-8 leading-relaxed max-w-md font-Blackadder ITC">
