      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative animate-in zoom-in duration-1000">
            ...
            {/* Floating Stats Card — top right corner */}
            <div className="absolute -top-6 -right-6 sm:-top-8 sm:-right-8 bg-white p-6 rounded-3xl shadow-2xl border border-slate-100 animate-bounce-slow z-10">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-[#EEF2FF] rounded-2xl flex items-center justify-center text-[#6366F1] shrink-0">
                  <svg
                ...
                <div>
                  ...
                  <div className="text-sm font-bold text-[#64748B] whitespace-nowrap">
                    Students Placed
                  </div>
                </div>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-15">
              <div className="p-5 rounded-2xl bg-slate-900 text-white flex flex-col justify-between">
                <div>
                  <p className="font-bold mb-1">Not sure where to start?</p>
                  <p className="text-slate-300 text-sm mb-4">
                    Take our 60-second quiz to find your best-fit service.
                  </p>
                </div>

                <a href="#"
                  className="inline-flex items-center text-emerald-400 font-semibold text-sm hover:text-emerald-300"
                >
                  Take the Quiz →
                </a>
              </div>

              <div className="p-5 rounded-2xl bg-white ring-1 ring-slate-100 shadow-sm flex flex-col justify-between">
                <div>
                  <div className="flex gap-0.5 text-amber-400 text-sm mb-2">
                    ★★★★★
                  </div>
                  <p className="text-slate-600 text-sm italic mb-3">
                    "Landed my first part-time role in under a week — the
                    whole process felt built for students, not corporates."
                  </p>
                </div>
